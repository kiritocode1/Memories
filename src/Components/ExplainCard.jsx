    ...
    return (
			<div className="w-full flex items-center justify-center px-20 mt-20">
				<Collapse.Group accordion animated bordered >
                    ...
                    <Text h4>
                        The main idea behind this project is to help people to find the best way to help the people in need. this is an experimental project to check how Ai could help  phsycology. 
